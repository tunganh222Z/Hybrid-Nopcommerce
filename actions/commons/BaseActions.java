...
public class BaseActions extends BasePage{
    ...
    public void openModuleInHeaderMenu(String module) {
        waitForElementClickable(driver, BaseActionsPageUI.DYANMIC_MODULE_HEADER_MENU, module);
        clickToElement(driver, BaseActionsPageUI.DYANMIC_MODULE_HEADER_MENU, module);
    }
